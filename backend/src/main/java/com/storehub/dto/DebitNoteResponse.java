...
public class DebitNoteResponse {
    ...
    public static DebitNoteResponse fromEntity(DebitNote note) {
        return DebitNoteResponse.builder()
                .id(note.getId())
                .voucherNumber(note.getVoucherNumber())
                .noteType(note.getNoteType())
                .sourcePurchaseId(note.getSourcePurchase().getId())
                .sourcePurchaseNumber(note.getSourcePurchase().getPurchaseNumber())
                .supplier(SupplierResponse.fromEntity(note.getSupplier()))
                ...
                .items(note.getItems().stream().map(DebitNoteItemResponse::fromEntity).toList())
