...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Purchases', path: '/purchases', icon: ShoppingCart, enabled: true, allowedRoles: ['ADMIN', 'STORE_MANAGER', 'PURCHASE_USER'] },
  { label: 'Sales', path: '/sales', icon: Receipt, enabled: true },
  { label: 'Accounting', path: '/accounting', icon: BookText, enabled: true, allowedRoles: ['ADMIN', 'STORE_MANAGER', 'ACCOUNTANT'] },
  { label: 'GST Reports', path: '/gst-reports', icon: FileSpreadsheet, enabled: true, allowedRoles: ['ADMIN', 'STORE_MANAGER', 'ACCOUNTANT'] },
  ...
  { label: 'Roles & Permissions', path: '/admin/roles-permissions', icon: KeyRound, enabled: true, allowedRoles: ['ADMIN'] },
