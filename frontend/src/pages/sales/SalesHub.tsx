...
export default function SalesHub() {
  ...
  const statCards = [
    { label: 'Total Sales Orders', value: summary?.totalSalesOrders, icon: ClipboardList },
    { label: 'Pending Orders', value: summary?.pendingOrders, icon: Clock },
    { label: 'Total Sales Bills', value: summary?.totalSalesBills, icon: FileText },
    { label: 'Total Receivables', value: summary ? money(summary.totalReceivables) : undefined, icon: Wallet },
    { label: "Today's Sales", value: summary ? money(summary.todaysSales) : undefined, icon: TrendingUp },
  ];
  ...
  const sections = [
    {
      key: 'orders',
      title: 'Sales Order',
      description: 'Create and track customer orders before they are billed.',
      icon: ClipboardList,
      path: '/sales/orders',
    },
    {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Sales" description="Sales Orders, Sales Bills, and Receipt Entries in one place." />
